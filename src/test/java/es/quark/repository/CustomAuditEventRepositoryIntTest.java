package es.quark.repository;

import es.quark.TasksApp;
import es.quark.config.Constants;
import es.quark.config.audit.AuditEventConverter;
import es.quark.domain.PersistentAuditEvent;
...
import static es.quark.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
