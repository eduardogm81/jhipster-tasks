...
import es.quark.TasksApp;
import es.quark.domain.Authority;
import es.quark.domain.User;
import es.quark.repository.AuthorityRepository;
...
import es.quark.web.rest.errors.ExceptionTranslator;
import es.quark.web.rest.vm.KeyAndPasswordVM;
import es.quark.web.rest.vm.ManagedUserVM;
